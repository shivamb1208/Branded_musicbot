...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Branded_sarver123")
                await self.one.join_chat("Branded_sarver123")
                await self.one.join_chat("Official_silent_world")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Branded_sarver123")
                await self.two.join_chat("Branded_sarver123")
                await self.two.join_chat("Official_silent_world")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Branded_sarver123")
                await self.three.join_chat("Branded_sarver123")
                await self.three.join_chat("official_silent_world")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Branded_sarver123")
                await self.four.join_chat("Branded_sarver123")
                await self.four.join_chat("official_silent_world")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Branded_sarver123")
                await self.five.join_chat("Branded_sarver123")
                await self.five.join_chat("official_silent_world")
            except:
                pass
            assistants.append(5)
